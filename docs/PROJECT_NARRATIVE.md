...
2. Run or open the build artifact for rhino and interact with the primary experience.
...
## Progress
- Latest commit: 3cb7baa (2026-03-03) - docs: add professional README with badges
- Total commits: 2
